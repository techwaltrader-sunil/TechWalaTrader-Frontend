...
//         <div className="lg:col-span-4 bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-xl p-6 shadow-sm"><h3 className="text-lg font-bold text-gray-800 dark:text-white">Join Us</h3></div>
//         <div className="lg:col-span-8 bg-gradient-to-r from-blue-600 to-blue-500 rounded-xl shadow-lg p-8"><h3 className="text-xl font-bold text-white">Need Help?</h3></div>
//       </div>
...
const AlgoDashboard = () => {
  ...
  return (
    <div className="p-6 min-h-screen bg-gray-50 dark:bg-slate-950 text-gray-900 dark:text-white font-sans transition-colors duration-300">
      ...
      {/* 4. Bottom Section: Join Us & Support */}
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
