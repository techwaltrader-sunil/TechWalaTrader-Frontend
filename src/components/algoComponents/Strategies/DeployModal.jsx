...
//   const handleSelectAllBrokers = () => {
//     if (
//       selectedBrokers.length === availableBrokers.length &&
...
//               <div className="flex items-center gap-3">
//                 <span
//                   className={`text-sm font-bold transition-colors ${isLive ? "text-blue-600 dark:text-blue-500" : "text-gray-400 dark:text-gray-500"}`}
//                 >
//                   Live
//                 </span>
...
//                 >
//                   <div
//                     className={`bg-white w-4 h-4 rounded-full shadow-md transform transition-transform ${!isLive ? "translate-x-6" : "translate-x-0"}`}
//                   ></div>
//                 </div>

//                 <span
//                   className={`text-sm font-bold transition-colors ${!isLive ? "text-gray-800 dark:text-white" : "text-gray-400 dark:text-gray-500"}`}
//                 >
//                   Forward Test
//                 </span>
//               </div>
...
//                         className="w-4 h-4 text-blue-600 rounded border-gray-300 cursor-pointer accent-blue-600"
//                       />
//                       <span className="text-sm font-semibold text-gray-800 dark:text-gray-200 group-hover:text-blue-600 transition-colors">
//                         Select All
//                       </span>
//                     </label>
...
// import React, { useState, useEffect } from 'react';
// import { X, Clock, AlertTriangle, Loader2 } from 'lucide-react';
// import { getConnectedBrokers } from '../../../data/AlogoTrade/brokerService'; // Apne path ke anusar adjust karein
...
//           // 🔥 NAYA LOGIC: Strategy ke Risk Management se default values uthana 🔥
//           const riskData = strategy?.data?.riskManagement || {};
//           setMaxProfit(riskData.maxProfit || 0);
//           setMaxLoss(riskData.maxLoss || 0);
//           // Agar noTradeAfter set hai to wahi dikhao, varna default 15:15
...
//           fetchBrokers();
//       }
//   }, [isOpen, strategy]); // ✅ strategy ko dependency me dala taki naya data aate hi update ho jaye
