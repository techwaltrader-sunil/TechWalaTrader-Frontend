...
//         if (!legs.find(l => l.id === activeLegId) && legs.length > 0) {
//             setActiveLegId(legs[legs.length - 1].id);
//         }
//     }
...
//         {legs.map((leg, index) => {
//           const isExpanded = legs.length === 1 || leg.id === activeLegId;
...
//                                                     e.preventDefault(); 
//                                                     e.stopPropagation(); 
//                                                     setShowStrikeTooltip(!showStrikeTooltip); 
//                                                 }}
//                                                 className="text-blue-500 outline-none p-0.5 hover:bg-blue-50 dark:hover:bg-slate-700 rounded-full transition-colors"
//                                             >
//                                                 <Info size={14} />
//                                             </button>
...
//                                                             className={`px-2 py-0.5 rounded text-[10px] font-bold transition-colors ${tooltipLang === 'en' ? 'bg-blue-600 text-white' : 'text-gray-500 dark:text-gray-400'}`}
//                                                         >
//                                                             EN
//                                                         </button>
//                                                         <button 
...
//                                                             className={`px-2 py-0.5 rounded text-[10px] font-bold transition-colors ${tooltipLang === 'hi' ? 'bg-blue-600 text-white' : 'text-gray-500 dark:text-gray-400'}`}
//                                                         >
//                                                             HI
//                                                         </button>
//                                                     </div>
...
//                                                             </div>
//                                                             <div>
//                                                                 <strong className="text-green-600 dark:text-green-400">🧠 On Close:</strong> <span className="text-gray-600 dark:text-gray-300 block mt-0.5 leading-relaxed">ट्रेंड फॉलोअर्स के लिए। कैंडल क्लोज होने का इंतज़ार करेगा ताकि फेक शैडो (Wicks) से SL हिट ना हो।</span>
//                                                             </div>
//                                                         </>
//                                                     ) : (
//                                                         <>
...
//                                                             </div>
//                                                             <div>
//                                                                 <strong className="text-green-600 dark:text-green-400">🧠 On Close:</strong> <span className="text-gray-600 dark:text-gray-300 block mt-0.5 leading-relaxed">कैंडल के टारगेट के ऊपर क्लोज होने का इंतज़ार करेगा। (बड़े ट्रेंड्स कैप्चर करने के लिए)</span>
//                                                             </div>
//                                                         </>
//                                                     ) : (
//                                                         <>
